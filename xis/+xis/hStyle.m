	...
	methods (Access = public)
		...
		% fig : figure (scalar numeric)
			...
			fig = figure( ...
				...
				'PaperUnits', 'points', ...
				'defaultTextFontSize', 9, 'defaultAxesFontSize', 9, ...
				'defaultAxesBox', 'on', 'defaultAxesLayer', 'top', ...
				varargin{:} );

				%'Color', this.color( 'grey', this.scale( -1/3 ) ), ...
				%'defaultTextFontSize', 10, 'defaultAxesFontName', 'DejaVu Sans Mono', 'defaultAxesFontSize', 10, ...
				%'defaultAxesNextPlot', 'add', ... % conflicts w/ polar plot
